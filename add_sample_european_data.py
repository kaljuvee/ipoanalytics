#!/usr/bin/env python3
"""
Script to add sample European IPO data for testing country/exchange filters
"""
...
def add_sample_european_data():
    """Add sample European IPO data to test all country/exchange combinations"""
    ...
    cursor.execute("SELECT DISTINCT country FROM ipo_data")
